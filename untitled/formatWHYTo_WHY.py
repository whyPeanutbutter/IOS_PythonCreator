        ...
        if not needJump:
            ...
            if len(arrTemp) > 1:
                if "string" in arrTemp:
                    outStr = outStr + '\n' + "@property (nonatomic, copy) NSString *" + strTemp + ';'
                    ...
                    outStr = outStr + '\n' + "@property (nonatomic, assign) NSInteger " + strTemp + ';'
                    ...
                    outStr = outStr + '\n' + "@property (nonatomic, assign) CGFloat " + strTemp + ';'
                elif ("object" in arrTemp):
                    outStr = outStr + '\n' + "@property (nonatomic, strong) EL" + strTemp[0:1].capitalize() + strTemp[
                                                                                                              1:] + ' *' + strTemp + ';(这是推测类型)'
                elif ("object[]" in arrTemp):
                    outStr = outStr + '\n' + "@property (nonatomic, strong) NSArray<EL" + strTemp[
                                                                                          0:1].capitalize() + strTemp[
                                                                                                              1:] + ' *' + "> *" + strTemp + ';(这是推测类型)'
                elif ("string[]" in arrTemp):
                    outStr = outStr + '\n' + "@property (nonatomic, copy) NSArray<NSString *> *" + strTemp + ';'
                else:
                ...
                if arrTemp[0] == 'success':
                    ...
                    outStr = "@interface " + strTemp + ' : ELBaseResponse (这是推测类型)'
                else:
                    outStr = outStr + "\n@end\n" + '\n\n' + "@interface EL" + strTemp[0:1].capitalize() + strTemp[
                                                                                                          1:] + ' : NSObject (这是推测类型)'
